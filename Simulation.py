...
if __name__ == '__main__':
    ...
    if args.SMAX:
        ...
        config["maximum_change_schedule"] = 500
    if args.sigma:
    ...
    if args.m:
        ...
        config["UserGroups"] = 3  # number of unique parameters
    if args.namelabel:
    ...
    algorithms['CoDBand'] = CoDBand(d=config["context_dimension"], lambda_=config["lambda_"], NoiseScale=config["NoiseScale"], alpha_prior={'a': 10., 'b': 1.}, tau_cd=25)
